                ...
                import { Search, Target, Users, BookOpen, Trophy, Globe } from 'lucide-react';
                            ...
                            <div className="homepage-calculator-result">
                              <div className="homepage-calculator-result-content">
                                ...
                                <p className="homepage-calculator-description">
                                  GPA와 SAT 점수를 기반으로 한 간단한 계산입니다.<br />
                                  과외활동, 에세이, 개인화된 대학 추천을 포함한 종합적인<br />
                        ...
                        <div className="features-container">
                          ...
                          <div className="features-grid">
                            <div className="feature-card">
                              <div className="feature-card-content">
                                <div className="feature-title-row">
                                  <h3 className="feature-card-title">학교 정보<br />모아보기</h3>
                            ...
                            <div className="feature-card">
                              <div className="feature-card-content">
                                <div className="feature-title-row">
                                  <h3 className="feature-card-title">개인 맞춤<br />프로필 분석</h3>
                            ...
                            <div className="feature-card">
                              <div className="feature-card-content">
                                <div className="feature-title-row">
                                  <h3 className="feature-card-title">컨설팅 프로그램<br /> 비교/추천</h3>
                        ...
                        <div className="majors-container">
                          <div className="majors-header">
                            ...
                            <p className="majors-subtitle">
                              간단한 테스트로 나에게 맞는 전공을 찾아보세요.<br />* 평균 연봉과 취업률은 추정치입니다.
                            </p>
                          </div>
