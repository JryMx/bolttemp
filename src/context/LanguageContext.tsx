...
const translations = {
  ko: {
    ...
    'universities.filter.sort.name-asc': '알파벳순 (A–Z)',
    'universities.filter.sort.name-desc': '알파벳순 (Z–A)',
    ...
    // Compare Page
    'compare.title': '학교 비교하기',
    'compare.description': '최대 4개 대학을 나란히 비교하여 합격 전략을 세워보세요.',
    'compare.selected.title': '선택한 대학',
    'compare.selected.count': '{count}/4',
    'compare.add.button': '대학 추가',
    'compare.remove.button': '제거',
    'compare.search.title': '대학 추가',
    'compare.search.placeholder': '대학명으로 검색...',
    'compare.search.no-results': '검색 결과가 없습니다.',
    'compare.empty.title': '대학을 추가하여 비교를 시작하세요',
    'compare.empty.description': '최소 2개 이상의 대학을 선택하면 상세 비교를 볼 수 있습니다.',
    'compare.empty.action': '대학 추가하기',
    'compare.category.basic': '기본 정보',
    'compare.category.admission': '입학 통계',
    'compare.category.outcomes': '졸업 후 성과',
    'compare.field.location': '위치',
    'compare.field.type': '유형',
    'compare.field.size': '학부 재학생 수',
    'compare.field.tuition': '학비',
    'compare.field.acceptance-rate': '합격률',
    'compare.field.sat-range': 'SAT 범위',
    'compare.field.act-range': 'ACT 범위',
    'compare.field.gpa': '평균 GPA',
    'compare.field.graduation-rate': '4년 졸업률',
    'compare.field.degree-types': '학위 유형',
    'compare.toast.added': '{name}이(가) 비교 목록에 추가되었습니다',
    'compare.toast.removed': '{name}이(가) 비교 목록에서 제거되었습니다',
    'compare.toast.limit': '최대 4개 대학까지만 비교할 수 있습니다',
    'compare.toast.already-added': '이미 비교 목록에 추가된 대학입니다',
  },
  en: {
    // Navbar
    ...
    'compare.description': 'Compare up to 4 universities side by side to develop your admission strategy.',
    'compare.selected.title': 'Selected Universities',
    'compare.selected.count': '{count}/4',
    'compare.add.button': 'Add University',
    'compare.remove.button': 'Remove',
    'compare.search.title': 'Add University',
    'compare.search.placeholder': 'Search by university name...',
    'compare.search.no-results': 'No results found.',
    'compare.empty.title': 'Add universities to start comparing',
    'compare.empty.description': 'Select at least 2 universities to view detailed comparison.',
    'compare.empty.action': 'Add University',
    'compare.category.basic': 'Basic Information',
    'compare.category.admission': 'Admission Statistics',
    'compare.category.outcomes': 'Post-Graduation Outcomes',
    'compare.field.location': 'Location',
    'compare.field.type': 'Type',
    'compare.field.size': 'Undergraduate Enrollment',
    'compare.field.tuition': 'Tuition',
    'compare.field.acceptance-rate': 'Acceptance Rate',
    'compare.field.sat-range': 'SAT Range',
    'compare.field.act-range': 'ACT Range',
    'compare.field.gpa': 'Average GPA',
    'compare.field.graduation-rate': '4-Year Graduation Rate',
    'compare.field.degree-types': 'Degree Types',
    'compare.toast.added': '{name} has been added to comparison list',
    'compare.toast.removed': '{name} has been removed from comparison list',
    'compare.toast.limit': 'You can compare up to 4 universities at a time',
    'compare.toast.already-added': 'This university is already in your comparison list',
  },
};
